...
import {authorizedPostRequest} from "../Request";
...
const AddProduct = () => {
    ...
    const handleSubmit = async e => {
        ...
        const callback = () => {
            toast.success("Przedmiot został dodany!", { position: toast.POSITION.BOTTOM_RIGHT });
            setError([])
        }
                    ...
                    <div className="mx-auto w-50 order-form-container p-5">
                        <form onSubmit={handleSubmit} className="mt-5">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" name="photo" placeholder="Wklej link ze zdjęciem" value={path} onChange={({ target }) => setPath(target.value)} required />
                            </div>
                            <div className="mb-3">
                                <h3>Kategoria</h3>
                            ...
                            <div className="mx-auto w-50">
                                <button type="submit" className="btn btn-primary btn-lg w-100">Dodaj przedmiot</button>
                            </div>
                        </form>
                    </div>
                </div>
